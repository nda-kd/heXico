  ...
  return (
    <div>
      <div
        ...
        onClick={(e) => selectedUserHandle(e, props)}
      >
        <img src={props.avatar} className="conversationList-avatar" alt="img" />
        <div className="conversationList-text">
          <div className="conversationList-info">
            <span id="conversationList-name">{props.username}</span>
            <span id="conversationList-ltsMsg">{props.description}</span>
          </div>
          <div id="conversationListv-date">{props.lastLogin}</div>
        </div>
      </div>
